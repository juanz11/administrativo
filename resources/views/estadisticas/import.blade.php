...
<div style="display: flex; gap: 0.75rem; flex-wrap: wrap; margin-bottom: 1rem;">
    <a href="{{ route('estadisticas.grafica') }}" class="btn-submit" style="width: auto; text-decoration: none;">Gráfica</a>
    <a href="{{ route('estadisticas.import.form') }}" class="btn-submit" style="width: auto; text-decoration: none;">Importar Excel</a>
    <a href="{{ route('estadisticas.historial') }}" class="btn-submit" style="width: auto; text-decoration: none;">Historial</a>
</div>
...
<div class="import-card">
    <form method="POST" action="{{ route('estadisticas.import') }}" enctype="multipart/form-data" id="importForm">
        @csrf
