...
<div style="display: flex; gap: 0.75rem; flex-wrap: wrap; margin-bottom: 1rem;">
    <a href="{{ route('estadisticas.grafica') }}" class="btn-primary">Gráfica</a>
    <a href="{{ route('estadisticas.import.form') }}" class="btn-primary">Importar Excel</a>
    <a href="{{ route('estadisticas.historial') }}" class="btn-primary">Historial</a>
</div>
                ...
                <tbody>
                    @foreach($importaciones as $importacion)
                        <tr>
                            ...
                            <td>
                                @if($importacion->id != $importacionActualId)
                                    <form method="POST" action="{{ route('estadisticas.historial.seleccionar', $importacion->id) }}" style="display: inline;">
                                        @csrf
...
@else
    <div class="table-card">
        <div class="empty-state">
            ...
            <a href="{{ route('estadisticas.import.form') }}" class="btn-primary">📤 Importar Primer Archivo</a>
        </div>
    </div>
@endif
@endsection
