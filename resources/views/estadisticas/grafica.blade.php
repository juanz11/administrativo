...
<div style="display: flex; gap: 0.75rem; flex-wrap: wrap; margin-bottom: 1rem;">
    <a href="{{ route('estadisticas.grafica') }}" class="btn-export">Gráfica</a>
    <a href="{{ route('estadisticas.import.form') }}" class="btn-export">Importar Excel</a>
    <a href="{{ route('estadisticas.historial') }}" class="btn-export">Historial</a>
</div>
...
@else
    ...
    <div class="filters-card">
        <form method="GET" action="{{ route('estadisticas.grafica') }}">
            ...
            <div style="display: flex; gap: 0.75rem; margin-top: 1rem;">
                ...
                <a href="{{ route('estadisticas.grafica') }}" class="btn-export">🔄 Limpiar Filtros</a>
            </div>
        </form>
    </div>
