...
class EstadisticasVentasController extends Controller
{
    ...
    {
        return view('estadisticas.import');
    }
    ...
    public function import(Request $request): RedirectResponse
    {
        ...
        try {
            ...
            return redirect()->route('estadisticas.import.form')->withErrors(['excel' => 'Error al procesar el archivo: ' . $e->getMessage()]);
        }
        ...
        return redirect()->route('estadisticas.grafica')->with('success', 'Archivo importado y guardado correctamente.');
    }
    ...
    public function grafica(Request $request): View
    {
        ...
        if (!$importacionId) {
            return view('estadisticas.grafica', [
                'labels' => [],
                'percentages' => [],
                'unitsByLabel' => [],
                'totalUnits' => 0,
    ...
    public function seleccionarImportacion(Request $request, int $id): RedirectResponse
    {
        ...
        return redirect()->route('estadisticas.grafica')->with('success', 'Importación seleccionada correctamente.');
    }
}
